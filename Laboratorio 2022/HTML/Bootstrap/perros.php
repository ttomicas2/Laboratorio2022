        ...
        <div class="row align-items-center">
            <div class="col align-self-center">
                <div class="card" style="width: 21rem;">
                    <img src="Perros/Alimento Nutrique Medium Young Adult.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="height: 4rem;">Alimento Nutrique Medium Young Adult - 12 Kg</h5>
                        <p class="card-text">$ 10805,00</p>
            ...
            <div class="col align-self-center">
                <div class="card" style="width: 21rem;">
                    <img src="Perros/pelotaTennis.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="height: 4rem;">Pelota Puppis Tennis</h5>
                        <p class="card-text">$ 462,00</p>
                        <a href="#" class="btn btn-primary">Ver Producto</a>
                    </div>
                </div>
            </div>
            <div class="col align-self-center">
                <div class="card" style="width: 21rem;">
                    <img src="Perros/camaBordo.png" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title" style="height: 4rem;">Moisés Puppis Classic Bordó</h5>
                        <p class="card-text">$ 7220,00</p>
                        <a href="#" class="btn btn-primary">Ver Producto</a>
                    </div>
                </div>
            </div>
